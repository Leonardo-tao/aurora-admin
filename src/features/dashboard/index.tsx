      ...
      <Main>
        ...
        <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
          <Card>
            ...
            <CardContent>
              ...
              <p className='text-muted-foreground text-xs'>R2 原图 + 元数据</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
              <CardTitle className='text-sm font-medium'>精选作品</CardTitle>
            ...
            <CardContent>
              ...
              <p className='text-muted-foreground text-xs'>展示在首页精选区</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <Card>
            <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
              <CardTitle className='text-sm font-medium'>近 30 天上传</CardTitle>
            ...
            <CardContent>
              ...
              <p className='text-muted-foreground text-xs'>按入库时间统计</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className='mt-4'>
          <CardHeader>
            ...
            <CardDescription>
              缩略图经 Cloudflare Transformations 转为 webp（无 EXIF）；下载原图保留完整 EXIF
            </CardDescription>
          </CardHeader>
          <CardContent>
            <RecentPhotos />
